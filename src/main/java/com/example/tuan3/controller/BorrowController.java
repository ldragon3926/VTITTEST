...
public class BorrowController {
    ...
    public ResponseEntity<?> view(@RequestParam(name = "page", defaultValue = "0", required = false) Integer page){
        return ResponseUltils.success(borrowService.phanTrang(page),"ROLE_VIEW_BORROW","Lấy danh sách phân trang thành công");
    }


    @GetMapping("/all")
    public ResponseEntity<?> getAll(){
        return ResponseUltils.success(borrowService.findAll(),"ROLE_VIEW_BORROW", "Lấy tất cả danh sách phiếu mượn thành công");
    }
    ...
    public ResponseEntity<?> getOne(@PathVariable(name = "id") Long id){
        ...
        return ResponseUltils.success(borrowService.getOne(id),"ROLE_VIEW_BORROW", "Lấy phiếu mượn thành công");
    }
    @PostMapping("/create")
    public ResponseEntity<?> add(@RequestBody @Valid BorrowSet borrowSet, BindingResult bindingResult ){
        ...
        return ResponseUltils.success(borrowService.add(borrow), "ROLE_CREATE_BORROW", "Thêm phiếu mượn thành công");
    }
    ...
    public ResponseEntity<?> update(@RequestBody @Valid BorrowSetUpdate borrowSet, BindingResult bindingResult, @PathVariable(name = "id") Long id ){
        ...
        Borrows borrow = borrowSet.dto(new Borrows());
        return ResponseUltils.success(borrowService.update(borrow, id),"ROLE_UPDATE_BORROW", "Update phiếu mượn thành công");
    }
    ...
    public ResponseEntity<?> delete( @PathVariable(name = "id") Long id ){
        ...
        return ResponseUltils.success(null,"ROLE_DELETE_BORROWS", "Xóa phiếu mượn thành công");
    }
}
