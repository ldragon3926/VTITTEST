...
public class CommentController {
    ...
    public ResponseEntity<?> view(@RequestParam(name = "page", defaultValue = "0", required = false) Integer page) {
        return ResponseUltils.success(commentService.phanTrang(page), "Lấy danh sách phân trang thành công");
    }

    @GetMapping("/all")
    public ResponseEntity<?> getAll() {
        return ResponseUltils.success(commentService.findAll(), "Lấy tất cả danh sách comment thành công");
    }
    ...
    public ResponseEntity<?> getOne(@PathVariable(name = "id") Long id) {
        ...
        return ResponseUltils.success(commentService.getOne(id), "Lấy comment thành công");
    }
    ...
    public ResponseEntity<?> add(@RequestBody @Valid CommentSet commentSet, BindingResult bindingResult) {
        ...
        return ResponseUltils.success(commentService.add(comment), "Thêm comment thành công");
    }
    ...
    public ResponseEntity<?> update(@RequestBody @Valid CommentSet commentSet, BindingResult bindingResult, @PathVariable(name = "id") Long id) {
        ...
        Comment comment = commentSet.dto(newComment);
        return ResponseUltils.success(commentService.update(comment, id), "Update comment thành công");
    }
    ...
    public ResponseEntity<?> delete(@PathVariable(name = "id") Long id) {
        ...
        return ResponseUltils.success(null, "Xóa comment thành công");
    }
